...
;; during development we want to use the latest
;; version, not the released one
(if (file-readable-p "agda2-mode-improvements.el")
    (load-file "agda2-mode-improvements.el")
  (load "agda2-mode-improvements"))
